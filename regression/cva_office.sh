...
#	for reset_num in "${reset_nums[@]}"; do 
          # normal
          tsk='finalnorm'_${num_fns}_${num_eval_updates}_${num_inner_updates}_${tasks_per_metaupdate}
          python ./main.py --cva --n_iter 500000 --num_fns ${num_fns} --lr_inner 0.0005 --lr_meta 0.0005 \
